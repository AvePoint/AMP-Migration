...
$dllFullName = Join-Path -Path $ClrPath -ChildPath 'Microsoft.PowerShell.AMPMigration.v001.dll'
if(-not (Test-Path -Path $dllFullName -PathType Leaf)) {
    . (Join-Path -Path $PSScriptRoot -ChildPath 'AssemblyGenerationHelpers.ps1')
    New-SDKAssembly -AssemblyFileName 'Microsoft.PowerShell.AMPMigration.v001.dll' -IsAzureSDK:$False
}
