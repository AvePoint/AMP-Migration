...
{
    [OutputType([Microsoft.PowerShell.AMPMigration.v001.Models.ServiceResponsePageResultViewModelListJobSummaryModel])]
...
'@ 
    ...
    if ('SPJobByPlan_Find' -eq $PsCmdlet.ParameterSetName) {
        Write-Verbose -Message 'Performing operation FindWithHttpMessagesAsync on $AvePointMigrationPlatformAPI.'
        $taskResult = $AvePointMigrationPlatformAPI.SPJobByPlan.FindWithHttpMessagesAsync($Id, $PageNumber, $PageSize)
    } else {
