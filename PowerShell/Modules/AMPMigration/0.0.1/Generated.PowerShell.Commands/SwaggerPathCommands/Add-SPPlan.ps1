...
function Add-SPPlan
{
    [OutputType([Microsoft.PowerShell.AMPMigration.v001.Models.ServiceResponsePlanSummaryModel])]
    ...
    param(    
        ...
        [Microsoft.PowerShell.AMPMigration.v001.Models.SharePointPlanModel]
        $PlanSettings,
...
'@ 
    ...
    if ('SPPlan_Add' -eq $PsCmdlet.ParameterSetName) {
        Write-Verbose -Message 'Performing operation AddWithHttpMessagesAsync on $AvePointMigrationPlatformAPI.'
        $taskResult = $AvePointMigrationPlatformAPI.SPPlan.AddWithHttpMessagesAsync($PlanSettings)
    } else {
