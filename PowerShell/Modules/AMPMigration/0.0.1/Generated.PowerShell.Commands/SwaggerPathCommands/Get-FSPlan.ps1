...
function Get-FSPlan
{
    [OutputType([Microsoft.PowerShell.AMPMigration.v001.Models.ServiceResponseListPlanSummaryModel])]
    [CmdletBinding(DefaultParameterSetName='FSPlan_Get')]
    param(    
    ...
    $NewServiceClient_params = @{
        FullClientTypeName = 'Microsoft.PowerShell.AMPMigration.v001.AvePointMigrationPlatformAPI'
    }
...
'@ 
    ...
    $AvePointMigrationPlatformAPI = New-ServiceClient @NewServiceClient_params
    ...
    $skippedCount = 0
    $returnedCount = 0
    if ('FSPlan_Get' -eq $PsCmdlet.ParameterSetName) {
        Write-Verbose -Message 'Performing operation GetWithHttpMessagesAsync on $AvePointMigrationPlatformAPI.'
        $taskResult = $AvePointMigrationPlatformAPI.FSPlan.GetWithHttpMessagesAsync()
    } else {
