...
{
    [OutputType([Microsoft.PowerShell.AMPMigration.v001.Models.ServiceResponseStatusResultModel])]
    ...
    param(    
        ...
        [Parameter(Mandatory = $true, ParameterSetName = 'SPJobByPlan_Start')]
        [Microsoft.PowerShell.AMPMigration.v001.Models.PlanExecutionModel]
        $PlanSettings,
...
'@ 
    ...
    if ('SPJobByPlan_Start' -eq $PsCmdlet.ParameterSetName) {
        Write-Verbose -Message 'Performing operation StartWithHttpMessagesAsync on $AvePointMigrationPlatformAPI.'
        $taskResult = $AvePointMigrationPlatformAPI.SPJobByPlan.StartWithHttpMessagesAsync($Id, $PlanSettings)
    } else {
