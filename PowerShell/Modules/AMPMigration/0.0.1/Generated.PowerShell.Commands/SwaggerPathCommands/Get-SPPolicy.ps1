...
{
    [OutputType([Microsoft.PowerShell.AMPMigration.v001.Models.ServiceResponseListPolicySummaryModel])]
...
'@ 
    ...
    if ('SPPolicy_Get' -eq $PsCmdlet.ParameterSetName) {
        ...
        $taskResult = $AvePointMigrationPlatformAPI.SPPolicy.GetWithHttpMessagesAsync()
    } else {
