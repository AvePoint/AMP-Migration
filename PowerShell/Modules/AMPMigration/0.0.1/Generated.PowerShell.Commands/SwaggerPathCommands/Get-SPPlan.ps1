...
function Get-SPPlan
{
    ...
    [CmdletBinding(DefaultParameterSetName='SPPlan_Get')]
    param(    
...
'@ 
    ...
    $skippedCount = 0
    $returnedCount = 0
    if ('SPPlan_Get' -eq $PsCmdlet.ParameterSetName) {
        Write-Verbose -Message 'Performing operation GetWithHttpMessagesAsync on $AvePointMigrationPlatformAPI.'
        $taskResult = $AvePointMigrationPlatformAPI.SPPlan.GetWithHttpMessagesAsync()
    } else {
