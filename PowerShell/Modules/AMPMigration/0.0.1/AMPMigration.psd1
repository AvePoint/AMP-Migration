...
#
# Module manifest for module 'AMPMigration'
#
...
GUID = 'f9d1ac15-827d-4b87-b425-f01d6bb9b733'
...
FunctionsToExport = 'Find-SPJobByPlan', 'Get-FSJob', 'Get-FSPlan', 'Get-SPPlan', 
               'Find-FSJobByPlan', 'Add-FSPlan', 'Get-SPPolicy', 'Start-SPJobByPlan', 
               'Restart-SPJob', 'Get-FSPolicy', 'Get-SPJob', 'Restart-FSJob', 
               'Add-SPPlan', 'Start-FSJobByPlan', 'New-FSPlanObject', 
               'New-AccountObject', 'New-FSMappingContentObject', 
               'New-JobExecutionObject', 'New-FSPlanSettingsObject', 
               'New-SharePointPlanSettingsObject', 'New-SharePointMappingObject', 
               'New-SharePointObject', 'New-FSPathObject', 'New-PlanExecutionObject', 
               'New-SharePointPlanObject', 'New-SharePointMappingContentObject', 
               'New-ScheduleObject', 'New-FSMappingObject'
